...
var ColorSwatch = function (_a) {
    ...
    var _c = (0, react_1.useState)(function () { return getComputedColorValue(value); }), currentValue = _c[0], setCurrentValue = _c[1];
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "vs-color-swatch ".concat(className), children: [(0, jsx_runtime_1.jsx)("div", { className: "vs-color-swatch__color", style: { backgroundColor: currentValue } }), (0, jsx_runtime_1.jsxs)("div", { className: "vs-color-swatch__info", children: [(0, jsx_runtime_1.jsx)("h4", { className: "vs-color-swatch__name", children: name }), (0, jsx_runtime_1.jsx)("p", { className: "vs-color-swatch__value", children: currentValue }), description && (0, jsx_runtime_1.jsx)("p", { className: "vs-color-swatch__description", children: description }), onColorChange && ((0, jsx_runtime_1.jsx)("input", { type: "color", value: currentValue, onChange: handleChange, className: "vs-color-swatch__input", "aria-label": "Change ".concat(name, " color") }))] })] }));
};
var Colors = function (_a) {
    ...
    var _d = (0, react_1.useState)({}), colors = _d[0], setColors = _d[1];
    (0, react_1.useEffect)(function () {
    ...
    var handleColorChange = (0, react_1.useCallback)(function (colorName, newValue) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "vs-colors", children: [editable && ((0, jsx_runtime_1.jsx)("div", { className: "vs-colors__controls", children: (0, jsx_runtime_1.jsx)("button", { className: "vs-colors__undo-button", onClick: handleUndo, disabled: history.length === 0, "aria-label": "Undo last color change", children: "Undo Last Change" }) })), colorGroups.map(function (group) { return ((0, jsx_runtime_1.jsxs)("div", { className: "vs-colors__group", children: [(0, jsx_runtime_1.jsx)("h3", { className: "vs-colors__group-title", children: group.title }), (0, jsx_runtime_1.jsx)("div", { className: "vs-colors__swatches", children: group.colors.map(function (color) { return ((0, jsx_runtime_1.jsx)(ColorSwatch, { name: color.name, value: colors[color.name] || "var(".concat(color.variable, ")"), description: color.description, className: color.name.toLowerCase().includes('light') || color.name.toLowerCase().includes('alt') ? 'vs-color-swatch--light' : '', onColorChange: editable ? handleColorChange : undefined }, color.name)); }) })] }, group.title)); })] }));
};
