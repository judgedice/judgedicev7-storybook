...
var ColorSwatch = function (_a) {
    ...
    return (_jsxs("div", { className: "vs-color-swatch ".concat(className), children: [_jsx("div", { className: "vs-color-swatch__color", style: { backgroundColor: currentValue } }), _jsxs("div", { className: "vs-color-swatch__info", children: [_jsx("h4", { className: "vs-color-swatch__name", children: name }), _jsx("p", { className: "vs-color-swatch__value", children: currentValue }), description && _jsx("p", { className: "vs-color-swatch__description", children: description }), onColorChange && (_jsx("input", { type: "color", value: currentValue, onChange: handleChange, className: "vs-color-swatch__input", "aria-label": "Change ".concat(name, " color") }))] })] }));
};
export var Colors = function (_a) {
    ...
    return (_jsxs("div", { className: "vs-colors", children: [editable && (_jsx("div", { className: "vs-colors__controls", children: _jsx("button", { className: "vs-colors__undo-button", onClick: handleUndo, disabled: history.length === 0, "aria-label": "Undo last color change", children: "Undo Last Change" }) })), colorGroups.map(function (group) { return (_jsxs("div", { className: "vs-colors__group", children: [_jsx("h3", { className: "vs-colors__group-title", children: group.title }), _jsx("div", { className: "vs-colors__swatches", children: group.colors.map(function (color) { return (_jsx(ColorSwatch, { name: color.name, value: colors[color.name] || "var(".concat(color.variable, ")"), description: color.description, className: color.name.toLowerCase().includes('light') || color.name.toLowerCase().includes('alt') ? 'vs-color-swatch--light' : '', onColorChange: editable ? handleColorChange : undefined }, color.name)); }) })] }, group.title)); })] }));
};
